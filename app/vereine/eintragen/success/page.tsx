...
// ─────────────────────────────────────────────────────────────────
// app/vereine/eintragen/success/page.tsx
// Dunkle Erfolgsseite nach erfolgreicher Vereins-Einreichung
// ─────────────────────────────────────────────────────────────────

import Link from 'next/link'
import { motion } from 'framer-motion'
import { CheckCircle2, Mail, Clock, Globe } from 'lucide-react'
...
const INFO_ITEMS = [
  ...
  },
  {
    ...
    desc: 'Unser Team prüft die Angaben und schaltet den Verein frei.',
  },
  {
    icon: Globe,
    title: 'Dann sofort sichtbar',
    desc: 'Nach der Freischaltung erscheint der Verein in der Vereinssuche.',
  },
]

export default function VereinEintragenSuccessPage() {
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-6 py-16">
      ...
      >
        ...
        <p className="mt-3 text-[#A1A1AA] text-base max-w-md">
          Dein Verein wurde eingereicht. Wir prüfen ihn innerhalb von{' '}
