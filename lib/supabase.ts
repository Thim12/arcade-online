...
//
// Drei Varianten:
//   1. createServerClient()  → Server Components / Route Handlers (Node.js)
//   2. createBrowserClient() → Client Components (Browser)
//   3. supabaseAdmin         → Admin-Operationen (umgeht RLS, nur Server!)
// ─────────────────────────────────────────────────────────────────

import {
  createServerClient as createSSRServer,
  createBrowserClient as createSSRBrowser,
  type CookieOptions,
} from '@supabase/ssr'
